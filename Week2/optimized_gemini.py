"""Module for processing film keywords.

This module provides functions to find keywords associated with films and identify films with the most associated keywords.

Functions:
    find_film_keywords(film_keywords: dict, film_name: str) -> set:
        Finds keywords associated with a specific film name.
    find_films_with_keywords(film_keywords: dict, num_of_films: int) -> list:
